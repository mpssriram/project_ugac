        ...
        <div className="ui-page">
            <div className="ui-surface">
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                    ...
                    <Link className="ui-btn" to="/announcements">
                        View announcements
                    </Link>
                    <Link className="ui-btn" to="/contacts">
                        Contact UGAC
                    </Link>
                </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-12">
                <div className="ui-card md:col-span-4">
                    <div className="ui-h2">Quick actions</div>
                    <div className="mt-1 text-sm text-white/65">Jump to commonly used pages.</div>
                    <div className="mt-4 grid gap-2">
                        <Link className="ui-btn ui-cardHover justify-start border-white/10 bg-white/[0.02]" to="/topics">
                            Search topics
                        </Link>
                        <Link className="ui-btn ui-cardHover justify-start border-white/10 bg-white/[0.02]" to="/topic/flowcharts">
                            View flowcharts
                        </Link>
                        <Link className="ui-btn ui-cardHover justify-start border-white/10 bg-white/[0.02]" to="/contacts">
                            Email UGAC
                        </Link>
                    </div>
                </div>

                <div className="ui-card md:col-span-8">
                    <div className="flex items-baseline justify-between">
                        ...
                        <Link className="ui-btn" to="/topics">View all</Link>
                    </div>
                    <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                        {featured.map(s => (
                            <Link key={s.id} to={`/topic/${s.id}`} className="ui-topicCard group">
                                <div className="font-semibold text-white/95">{s.title}</div>
                                <div className="mt-2 line-clamp-3 text-sm leading-6 text-white/70">{s.body || 'Open to view details.'}</div>
                                <div className="ui-topicMeta">
